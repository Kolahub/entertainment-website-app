...
function Bookmark() {
  ...
  const bookmarkedMovies = entertainmentdata.filter(el => el.isBookmarked === true && el.category === 'Movie')
  const bookmarkedSeries = entertainmentdata.filter(el => el.isBookmarked === true && el.category === 'TV Series')
  ...
  return (
    <section className='flex flex-col lg:flex-row' id='Bookmarked'>
      ...
      <div className='font-custom w-full text-white pl-5 sm:pl-8 lg:pl-0 pt-8 sm:pt-3 lg:pt-16 overflow-x-hidden'>
        ...
        <div className="">
        <h1 className="font-light text-2xl sm:text-3xl mt-8 mb-5">Bookmarked Movies</h1>

<div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6 pr-5 sm:pr-8 pb-6">
{bookmarkedMovies.map((el) => (
      <div key={el.title}>
        ...
        <div className="">
        <h1 className="font-light text-2xl sm:text-3xl mt-8 mb-5">Bookmarked TV Series</h1>
