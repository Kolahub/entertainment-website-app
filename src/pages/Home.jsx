...
import { updateBookmarkData } from "../store/entertainmentDataActions.js";
  ...
  return (
    <section className="flex flex-col lg:flex-row" id="Home">
      ...
      <div className="relative font-custom w-full text-white pl-5 sm:pl-8 lg:pl-0 pt-8 sm:pt-3 lg:pt-16 overflow-x-hidden">
        ...
        {searchQuery ? (
          <SearchResults searchQueryRes={entertainmentdata} />
        ) : (
          <>
            {entertainmentdata.length > 0 ? (
              <div className="">
                <div className="mt-8" id="Trending">
                  ...
                  <div className="flex gap-5 overflow-x-scroll scrollbar-hidden">
                    {trending.map((el, i) => (
                      <div key={`${el.id}${i}`}>
                        <div
                          className={`relative bg-cover h-[160px] sm:h-56 w-[280px] sm:w-[470px] rounded-xl flex items-end cursor-pointer transition-all group`}
                          style={{
                            backgroundImage: `url(${el.thumbnail.trending.large})`,
                          }}
                        >
                ...
                <EntertainmentItems
                  ...
                  entertainment={recommendedForYou}
                />
              </div>
            ) : (
              <PageLoader />
